...
Before being able to use a specific package in R, it is necessary to firstly install it and then load it. To install the package `install.packages()` function is used:
```{r, eval=FALSE}
...
<div class = "blue">
**Hint**: Please note the presence of the quotation mark *""* in case of the first function and their lack in case of the second one. 
</div>
