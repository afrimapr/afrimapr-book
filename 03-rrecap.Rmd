...
### Getting help with R
R is a very powerful software with many different packages and functions which are continuously being developed and added. Therefore, it is difficult, if not impossible, to be familiar with all the packages and functions that are currently available. Hence, in order to learn more about 
To get help with different functions and packages 
R provides an extensive documentation `help()` function in R provides ex
