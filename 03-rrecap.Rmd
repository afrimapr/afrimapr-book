...
## Load data
There are different approaches that can be used to import your datasets, depending on where the data is located and in what file type it is stored. The easiest case is when the dataset is already part of the R package, as it will be automatically read in when the package is installed and loaded into R. For example:
```{r, eval=FALSE}
...
```
Create dataset called *africa*, provided in the package:
```{r, warning=FALSE, message=FALSE}
africa = ne_countries(continent="africa", returnclass="sf")
```
here describe elements of the function
