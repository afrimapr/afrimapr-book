...
<div class = "purple">
**Exercise 3.7.1**: Create three vectors containing character, integer and logical values, respectively. Each with 10 rows. Then bind them to generate a matrix with 3 columns and 10 rows.
</div>  
<br/>
<style>
div.purple { background-color:#e9d0f7; border-radius: 5px; padding: 20px;}
...
<div class = "purple">
**Exercise 3.7.3**: Create a data frame from the matrix created in the previous exercise. Rename column headers respectively to their content.
</div>  
<br/>
