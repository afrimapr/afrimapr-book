...
Let's start with basic elements in R studio window. As seen in Figure 3.1, the typical R studio window consists of 4 elements: R script, which is a new file that will contain your code, and which can be saved.
