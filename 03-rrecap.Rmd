...
Create spatial dataset called  *africa*, provided in the package:
```{r, warning=FALSE, message=FALSE}
africa = ne_countries(continent="africa", returnclass="sf")
```
Please note, the function *ne_countries* is specific for this package and different packages may use other functions to load the dataset into clobal environment.

You can view and explore the dataset using:
