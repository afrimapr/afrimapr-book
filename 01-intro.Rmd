...
Each chapter of the book follows similar, fixed structure. It begins with the presentation of chapter goals, including the list of learning objectives in a green box (hence they can be easily found in each section). Moreover, at the end of the subsection there is a purple box with exercises relevant for a given topic. Importantly, the solutions to the exercises are showed at the end of the chapter. The book also features yellow boxes that contain useful tips and shortcuts. At the end of each chapter there is also a small section with additional resources and links related to the topic.