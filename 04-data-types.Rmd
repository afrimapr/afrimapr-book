...
<div class = "blue">
Please note that spatial data types can be stored in many different formats, from Shapefile (.shp + .dbf + .prj + …), to GeoPackage (.gpkg), to GeoJSON (.json), to CSV files (.csv) and many more. It can be overwhelming sometimes to identify their format and how to open them in R software. In these situations don't hesitate to contact the owner of the data or use google! 
</div>
