...
This chapter is written for those with some knowledge of R and little experience with spatial data. If you are familiar with these data types, you can move on to the next chapter where visualisation of data types are explained in more detail. 
<br/>
...
The goal of a spatial map is to provide a model of reality. This could be on the scale of a street, a neighbourhood, a country or a continent. Depending on the topics you're interested in, this could be focussed on disease cases, landcover dynamics, location of schools and so on. The opportunities are endless. All the R software needs is information in points, lines, polygons and rasters which together form a model of reality. 
