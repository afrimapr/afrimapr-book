...
Instead, we might want to use `breaks` function to set them up manually to provide more differentiation. It is important to keep breaks values between minimum and maximum value in the data.
```{r, warning=FALSE}
tm_shape(africa)+
