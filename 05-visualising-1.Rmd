...
```{r c5-mapview-countries2, warning=FALSE, message=FALSE, fig.show='hold', out.width='75%'}
...
```{r c5-mapview-countries3, warning=FALSE, message=FALSE, fig.show='hold', out.width='75%'}
...
```{r c5-mapview-airports, warning=FALSE, message=FALSE, fig.show='hold', out.width='75%'}
...
```{r c5-tmap-countries2, results='hide', out.width="75%"}
tm_shape(africa)+
 tm_borders()
...
```{r c5-tmap-countries3, out.width="75%"}
tm_shape(africa)+
 tm_fill()
...
```{r c5-tmap-countries4,fig.show="hold", out.width="75%"}
...
```{r c5-tmap-countries5, out.width="75%"}
...
```{r c5-tmap-countries6, warning=FALSE, out.width="75%"}

>>>>>>> c86a525a29f39038fe27b27968d41062ef407ede
# tm_shape(africa)+
...
```{r c5-tmap-countries7, warning=FALSE, out.width="75%"}
...
```{r c5-tmap-countries-breaks, warning=FALSE, fig.show="hold", fig.cap = "Africa's population with default breaks (left), customised breaks (middle) and divided in bins (right).", out.width="33%"}
#default settings
# tm_shape(africa)+                                
...
tm_shape(afriairports)+  
  tm_dots(col = "type", shape = 21, size = 0.2, title = "Airport size", labels = c("Large", "Medium", "Small"), palette=c(large_airport='red', medium_airport='yellow', small_airport='blue'))
