...
tm_shape(africa)+                               
 tm_fill(col="pop_est", title="Population", breaks = custom_breaks)+
 tm_borders()
...
tm_shape(africa)+
 tm_fill(col="lastcensus", title="Year of last census", 
         palette = "Set1", legend.format = list(format="s"))+
 tm_borders()
...
tm_shape(africa)+
 tm_fill(col="gdp_md_est", title="GDP",  breaks = custom_breaks) +
 tm_borders()
```
