...
We can easily fill an interactive map with the colours based on one of the columns. Here we use population column to colours our map. Importantlz, when we hoover over specific country the population data for a given country is showed.
```{r, warning=FALSE, message=FALSE}
mapview(africountries, zcol = ("pop_est"))
```

Similarly, we can control for other features.
```{r, warning=FALSE, message=FALSE}
mapview(africountries, color = "red", col.regions = "white", lwd = 1.5)
```
