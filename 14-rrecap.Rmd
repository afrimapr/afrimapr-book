...
<div class = "purple">
**Exercise 14.7.1**: Create a vector 'a' that contains descending sequence of numbers from 50 to 30 that decreases by 2. Hint: use seq()
</div>  
...
<div class = "purple">
**Exercise 14.8.1**: Create three vectors containing character, integer and logical values, respectively. Each with 10 rows. Bind them to generate a matrix with 3 columns and 10 rows.
</div>  
<br/>
<style>
div.purple { background-color:#e9d0f7; border-radius: 5px; padding: 20px;}
...
<div class = "purple">
**Exercise 14.8.2**: Create a data frame from the matrix created in the previous exercise. Rename column headers to describe their content.
</div>  
<br/>
