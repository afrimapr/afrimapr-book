...
```{r c5-tmap-countries-breaks,warnings = FALSE, message = FALSE,out.width="60%", fig.cap="A map of African population with different breaks settings."}
#default settings
tm_shape(africountries) +
...
```{r, out.width= "60%", fig.cap="A histogram of population data distribution."}
hist(afripop2020)
```
...
```{r c5-tmap-countries-categorical, out.width="60%", fig.cap="The African airports - an example of categorical variables visualisation."}
