...
Therefore, manual breaks are a way to address this problem. For this, we set up breaks first, outside of the map-making code.

```{r }
breaks=c(0,1,10,100,1000,10000,25000)
