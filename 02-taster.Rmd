...
For the first 'Hello world !' or 'Hello Africa!' example you can use the `tmap` package to make a map of African country boundaries using data contained with the `afrilearndata` package.

```{r c2-hello-africa, message=FALSE, warning=FALSE}
