...
```{r c2-empty-static-map1, fig.cap = "Examples of maps"}
...
tm_shape(africa)+
 tm_polygons()+
  tm_layout(title = "Africa", title.position = c("center", "top"), inner.margins = 0.05, legend.text.size = 0.47)
...
```{r c2-empty-static-map2, warning = FALSE, fig.cap = "Examples of maps 2"}

#Basic map 2
map_basic_2 = tm_style("watercolor")+
  tm_shape(africa)+
      tm_fill(col = "pop_est", style = "jenks", title = "Population")+
        tm_layout(title = "Africa", title.position = c("center", "top"), legend.text.size = 0.50)
