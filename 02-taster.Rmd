...
tm_shape(africountries) + #dataset used to create a map
    tm_polygons(col = "pop_est", title = "Population") #function to draw polygons of the map, 'col' fills polygons based on the variable in the dataset, 'title' adjust the legend title
